...
class CRUDTestPlan:
    ...
    def add_test_plan(
        ...
        obj_data = AutoTestPlan(test_plan_name = obj_in.test_plan_name ,
                                ...
                                test_plan_state = obj_in.test_plan_state,
    ...
    def run_test_plan(
        ...
        k = executor.submit(self._test_plan_thread , db , test_plan_id)
        return 1
    def _test_plan_thread(self , db , test_plan_id):
    ...
    def _start_run_job(
        ...
        for job_detail in range(len(job_detail_list_by_api)):
            ...
            new_api_result = self._do_job_detail(db = db ,
                                                 ...
                                                 job_detail_api_id = job_detail_list_by_api[job_detail].api_id,
    ...
    def _do_job_detail(
            self , db , job_detail_id , job_detail_api_id , test_plan_host , test_plan_port
    ) -> bool:
        assert_result , assert_result_list = crud_project_case.run_project_case(db = db ,
                                                                                project_case_id = job_detail_api_id ,
    ...
    def _get_job_detail_by_test_plan_job_id_and_api_id(
        ...
        job_detail_list = db.query(AutoTestPlanJobDetail).filter(AutoTestPlanJobDetail.test_plan_job_id == test_plan_job_id and AutoTestPlanJobDetail.api_id == api_id).all()
    ...
    def _update_fail_count(
        ...
        db.query(AutoTestPlanJob).filter(AutoTestPlanJob.id == test_plan_job_id).update(
            {AutoTestPlanJob.success_count : fail_count})
        db.commit()
